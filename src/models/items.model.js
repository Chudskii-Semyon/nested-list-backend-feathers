...
const mongooseSchema = require('../services/items/items.mongoose');
// !end
...
let moduleExports = function (app) {
  ...
  const items = new mongooseClient.Schema(mongooseSchema, { timestamps: true });
  // !end

  let existingModel = mongooseClient.models['items']; // needed for client/server tests
  let returns = existingModel || mongooseClient.model('items', items);
